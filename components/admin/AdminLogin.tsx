...
//     if (result.success) {
//       // Store a token (even if it's temporary)
...
//             type="submit"
//             disabled={isLoading}
//             className="w-full bg-emerald-600 hover:bg-emerald-700 disabled:bg-gray-400 text-white py-3.5 rounded-xl font-semibold text-lg transition"
//           >
//             {isLoading ? "Logging in..." : "Login"}
//           </button>
//         </form>
