...
//                 Nairobi’s trusted neuro-rehabilitation clinic
//               </span>
//             </motion.div>
...
//               <Link
//                 href="#contact"
//                 className="btn-primary group flex items-center justify-center gap-2 !px-8 !py-3.5 text-base transition-all hover:shadow-xl hover:-translate-y-0.5"
//               >
...
//                 className="group flex items-center justify-center gap-2 rounded-2xl border border-white/20 bg-white/5 px-8 py-3.5 text-base text-white transition-all hover:bg-white/10 hover:border-white/30"
//               >
...
//           {/* RIGHT PANEL - Recovery Command Centre */}
//           <motion.div
